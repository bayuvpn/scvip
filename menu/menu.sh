...
rm -f /usr/bin/user
username=$(curl -sS https://raw.githubusercontent.com/bayuvpn/izin/main/ip | grep $MYIP | awk '{print $2}')
echo "$username" >/usr/bin/user
# validity
rm -f /usr/bin/e
valid=$(curl -sS https://raw.githubusercontent.com/bayuvpn/izin/main/ip | grep $MYIP | awk '{print $3}')
...
Exp1=$(curl https://raw.githubusercontent.com/bayuvpn/izin/main/ip | grep $MYIP | awk '{print $3}')
if [[ $today < $Exp1 ]]; then
sts="${Info}"
else
sts="${Error}"
...
clear
echo -e " ${BIAqua}┌────────────────────────────────────────────────┐${NC}"
echo -e " ${BILime}│ ${BIB}              𝗕𝗮𝘆𝘂 𝗩𝗽𝗻 𝗧𝘂𝗻𝗻𝗲𝗹𝗶𝗻𝗴              ${NC}${BILime} │${NC}"
echo -e " ${BIAqua}└────────────────────────────────────────────────┘${NC}"
echo -e " ${BICyan}┌────────────────────────────────────────────────┐${NC}"
...
echo -e " ${BICyan}│${NC} CREATOR      ${NC}:  BayuTunneling"
echo -e " ${BICyan}│${NC} TELEGRAM     ${NC}: t.me/BayuVpnStore
echo -e " ${BICyan}└────────────────────────────────────────────────┘${NC}"
echo -e " ${BICyan}┌────────────────────────────────────────────────┐${NC}"
...
5|05) clear ; menu-set ;;
6|06) clear ; running ;;
7|07) clear ; wget -q https://raw.githubusercontent.com/bayuvpn/scvip/update.sh && chmod +x update.sh && ./update.sh ;;
